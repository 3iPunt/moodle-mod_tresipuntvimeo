...
$string['completed'] = 'Aquest vídeo estarà disponible per veure\'l d\'aquí a poc';
...
$string['deleted'] = 'Aquest mòdul del curs s\'ha esborrat';
...
$string['discarded'] = 'Aquest vídeo s\'ha descartat per un de nou';
...
$string['error_folder'] = 'Error en moure el vídeo a la carpeta';
...
$string['error_uploading'] = 'S\'ha produït un error en pujar el vídeo a Vimeo';
$string['error_whitelist'] = 'No s\'ha actualitzat correctament la whitelist de la privacitat';
...
$string['filepath_not_found'] = 'No s\'ha seleccionat cap vídeo per pujar';
...
$string['id_video_missing'] = 'No s\'ha pogut recuperar l\'ID del vídeo a la resposta de Vimeo';
...
$string['not_executed'] = 'Aquest vídeo estarà disponible per veure\'l d\'aquí a poc';
...
$string['privacy:metadata'] = 'El plugin Videoconnect no emmagatzema cap dada personal.';
...
$string['uploading'] = 'Aquest vídeo estarà disponible per veure\'l d\'aquí a poc';
