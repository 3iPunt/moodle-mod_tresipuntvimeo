...
$string['privacy:metadata:vimeo'] = 'Video Connect publishes the uploaded videos on the Vimeo account configured by the site.';
$string['privacy:metadata:vimeo:name'] = 'The activity name, used as the video title on Vimeo.';
$string['privacy:metadata:vimeo:videofile'] = 'The video file selected by the teacher, which is uploaded to Vimeo and may contain personal data (images, voices).';
