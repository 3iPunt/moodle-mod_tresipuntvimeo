...
$string['privacy:metadata:vimeo'] = 'Video Connect publica los vídeos subidos en la cuenta de Vimeo configurada por el sitio.';
$string['privacy:metadata:vimeo:name'] = 'El nombre de la actividad, usado como título del vídeo en Vimeo.';
$string['privacy:metadata:vimeo:videofile'] = 'El fichero de vídeo seleccionado por el profesor, que se sube a Vimeo y puede contener datos personales (imágenes, voces).';
